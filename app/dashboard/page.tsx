...
const navItems = [
    {
        ...
        description: 'מקום אחד לניהול התיק שלכם - מעקב אחרי כל עסקה וניתוח הביצועים האישיים.',
    },
    {
        href: '/dashboard/community-portfolio',
        title: 'התיק של שירן',
        description: ' כל העסקאות שלי - פתוחות סגורות - זמינות לצפייה בזמן אמת.',
    },
    {
        href: '/dashboard/board',
        title: 'לוח המודעות',
        description: 'כאן מחכים לכם כל ההודעות , העידכונים והשיעורים החדשים - במקום אחד שלא מפספסים.',
    },
    {
        href: '/dashboard/risk-calculator',
        title: 'מחשבון סיכונים',
        description: 'כלי פשוט ומהיר לחישוב גודל העסקה - מותאם לגודל התיק שלכם.',
    },
    {
        href: '/dashboard/refer', // הנתיב לדף החדש
        title: 'חבר מביא חבר',
        description: 'מזמינים חברים ומקבלים חודש מתנה על כל הצטרפות - בלי הגבלה.',
    },
];
